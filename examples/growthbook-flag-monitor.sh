...
#   snapshot from `${XDG_STATE_HOME:-$HOME/.local/state}/cc-guard/
...
STATE_DIR="${CC_GROWTHBOOK_MONITOR_STATE_DIR:-${XDG_STATE_HOME:-$HOME/.local/state}/cc-guard/growthbook-flag-monitor}"
