...
#   CC_VERSION_BUMP_STATE     state file path (default: ~/.cache/cc-guard/last-cc-version)
#   CC_VERSION_BUMP_LOG       history log path (default: ~/.cache/cc-guard/cc-version-history.jsonl)
#   CC_VERSION_BUMP_OVERRIDE  override detected version (testing)
#
# Inspect the history:
#   tail -20 ~/.cache/cc-guard/cc-version-history.jsonl | jq .
#   jq -s 'map(.version) | unique' ~/.cache/cc-guard/cc-version-history.jsonl
#
...
STATE="${CC_VERSION_BUMP_STATE:-${HOME}/.cache/cc-guard/last-cc-version}"
LOG="${CC_VERSION_BUMP_LOG:-${HOME}/.cache/cc-guard/cc-version-history.jsonl}"
...
https://gist.github.com/gaebalai/158436e88d169406593d55bd84f0d7e9
