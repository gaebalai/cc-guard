...
#   CC_QUOTA_ANOMALY_LOG          Log path (default: ~/.cache/cc-guard/quota-anomaly.jsonl)
...
#
# Inspect the log:
#   tail -50 ~/.cache/cc-guard/quota-anomaly.jsonl
#   jq -s 'map(.total) | add' ~/.cache/cc-guard/quota-anomaly.jsonl

set -u

LOG="${CC_QUOTA_ANOMALY_LOG:-${HOME}/.cache/cc-guard/quota-anomaly.jsonl}"
