...
PATTERN="${CC_STANDING_RULE_PATTERN:-STANDING RULE|third strike|strict rule|MUST NOT|MUST ALWAYS|NEVER do|ALWAYS do|반드시|절대|해서는 안 된다|하지 마라}"
...
The following rules were marked as STANDING / MUST / NEVER / ALWAYS / 반드시 /
절대 etc. in your memory files, scanned at session start. They apply to this
