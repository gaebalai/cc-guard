...
#   https://gist.github.com/gaebalai/77bf08523bda41132087a03de4523d7a — but each
...
#   paths from cc-guard v2 plus the Margin Lab Gist for cross-source
...
Cross-source verification:
  https://gist.github.com/gaebalai/77bf08523bda41132087a03de4523d7a
