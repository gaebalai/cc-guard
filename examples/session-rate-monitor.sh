...
#   CC_SESSION_RATE_DIR          State dir (default: ~/.cache/cc-guard/session-rate)
...
#
# Inspect state:
#   ls -la ~/.cache/cc-guard/session-rate/
#   cat ~/.cache/cc-guard/session-rate/<session_id>

set -u

STATE_DIR="${CC_SESSION_RATE_DIR:-${HOME}/.cache/cc-guard/session-rate}"
