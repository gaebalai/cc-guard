...
# gaebalai/quota-leakage-audit.sh — across multiple sessions on a single
# operator, individual files were observed Read 3-5 times even when their
# content had not changed.
#
# Background:
#   https://gist.github.com/gaebalai/303431f8e32fed5081b6b2b89712c991 (cluster)
#   https://gist.github.com/gaebalai/0dbe97df416c53c43dd699b72f439060 (audit)
#
# How it works:
...
files). Audit: https://gist.github.com/gaebalai/0dbe97df416c53c43dd699b72f439060
