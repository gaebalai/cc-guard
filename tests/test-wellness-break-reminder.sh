...
assert_not_contains "before-threshold silent" "$OUT" "세션"
...
assert_contains "past-threshold emits reminder" "$OUT" "세션"
...
assert_not_contains "throttle suppresses reminder" "$OUT" "세션"
...
assert_contains "post-throttle emits again" "$OUT" "세션"
...
assert_not_contains "kill switch fully silent" "$OUT" "세션"
...
assert_contains "custom 5-min threshold fires at 10min" "$OUT" "세션"
...
assert_not_contains "stale flag suppresses reminder" "$OUT" "세션"
...
assert_not_contains "empty flag silent" "$OUT" "세션"
