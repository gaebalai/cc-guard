...
Or paste your `settings.json` into the [web tool](https://claudecode.to/cc-guard/) — no npm required.
...
- [COOKBOOK.md](https://github.com/gaebalai/claude-code-hooks/blob/main/COOKBOOK.md) — 19 hook recipes
- [cc-guard](https://github.com/gaebalai/cc-guard) — automated setup
- [Web Audit Tool](https://claudecode.to/cc-guard/) — browser-based setup generator
