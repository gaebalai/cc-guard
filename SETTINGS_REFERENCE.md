...
- [COOKBOOK.md](https://github.com/gaebalai/claude-code-hooks/blob/main/COOKBOOK.md) — 20 hook recipes
- [Migration Guide](MIGRATION.md) — from permissions to hooks
- [Ecosystem Comparison](https://claudecode.to/cc-guard/ecosystem.html) — all hook projects
- [Token Checkup](https://claudecode.to/cc-guard/token-checkup.html) — free 30-second token diagnostic with hook recommendations
